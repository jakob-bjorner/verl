...
def hf_tokenizer(name_or_path, is_instruct_model, correct_pad_token=True, correct_gemma2=True, **kwargs):
    ...
    if not is_instruct_model:
        tokenizer.chat_template = open("./base_model_chat_template.jinja", "r").read()
        print("using base chat template")
    return tokenizer
