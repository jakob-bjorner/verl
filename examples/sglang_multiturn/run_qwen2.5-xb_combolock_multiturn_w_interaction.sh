...
# DEBUG=debug DSET=interaction_base INSTRUCT=True B=0.5 GPUS=1 CUDA_VISIBLE_DEVICES="5" MICRO_BATCH_SIZE=1 N_ROLLOUT=1 TRAIN_BATCH_SIZE=1 TP=1 MULTI_CONTEXT=True bash examples/sglang_multiturn/run_qwen2.5-xb_combolock_multiturn_w_interaction.sh
